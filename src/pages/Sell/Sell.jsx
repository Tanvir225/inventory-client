        ...
        <div className='space-y-5 '>
            ...
            <div className="flex justify-between items-center  p-2 border-b-2 border-gray-200">
                <div>
                    ...
                    <p className="">Manage your Sells</p>
                    <p className="text-sm ">Total Sell: <span className="font-semibold text-primary">{total} TK</span></p>
                    <p className="text-sm ">Total Cash: <span className="font-semibold text-accent">{givenCash} TK</span></p>
                    <p className="text-sm ">Total due: <span className="font-semibold text-red-700">{due} TK</span></p>
